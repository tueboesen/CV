  ...
  \cventry
    ...
    {Jan 2022 - June 2022} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Hyperparameter/Model optimization using optuna.}
  ...
  \cventry
    ...
    {May 2019 - Aug 2021} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Published reversible mimetic graph neural networks for protein design and folding.}
        \item {Developed self-supervised conditional probability neural networks for protein folding inspired by natural language processing models.}
